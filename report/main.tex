...
La soumission sur Moodle vient avec deux binaires préconstruits dans le dossier \mintinline{bash}{prebuilt} (ils doivent être lancés sur une architecture Linux x86 64 bits). Ces deux binaires sont deux versions du projet qui sont encore incompatibles entre elles :
...
L'identifiant de la scène à charger doit être renseigné via le premier argument du binaire.
